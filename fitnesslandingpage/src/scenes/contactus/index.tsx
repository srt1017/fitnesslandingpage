...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section className="mx-auto w-5/6 pb-32 pt-24">
      <motion.div
      ...
      >
        ...
        >
          ...
          <p className="my-5">
            ...
            challenges, our gym offers the resources, expertise, and community
            to support your success. Get ready to transform your body, empower
            your mind, and discover the best version of yourself. Start your
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/fakebackend49@gmail.com"
            >
              <input
